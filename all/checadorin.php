...
<body>
	...
	<header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="checadorin.php">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					...
					<!--<li class="nav-item active"><a class="nav-link" href="checadorin.php">Home</a></li>
					<li class="nav-item "><a class="nav-link" href="descanso.php">Tomar descanso</a></li>-->
				...
				<div class="col-lg-12">
        			...
        			<p id="date">date</p>	
								...
								<div class="submit-button text-center">
										<button class="btn btn-common" id="submit" type="submit">Registre su entrada</button>
