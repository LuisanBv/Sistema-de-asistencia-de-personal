...
<form action="eliminarhor.php" method="POST">
...
<form action="php/eliminarhora.php" class="formulario" id="formulario">
	...
	<!------------------------------------------------>
			...
			<div class="formulario__grupo" id="grupo__nombres">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="area" id="area" placeholder="Ingrese el area" value="<?php echo $area;?>" disabled>
			...
			<div class="formulario__ncon" id="grupo__ncontrol">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="descripcion" id="descripcion" placeholder="Ingrese la descripcion"value="<?php echo $descripcion;?>" disabled>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__ap">
				...
				<div class="formulario__grupo-input">
					<input type="time" class="formulario__input" name="inicio" id="inicio" placeholder="Ingrese la hora de incio 07:00 hrs" value="<?php echo $inicio;?>"disabled>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__am">
				...
				<div class="formulario__grupo-input">
					<input type="time" class="formulario__input" name="fin" id="fin" placeholder="Ingrese la hora de termino 13:00 hrs" value="<?php echo $fin;?>"disabled>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo formulario__grupo-btn-enviar">
				<button type="submit" class="formulario__btn">Eliminar Horario</button>
