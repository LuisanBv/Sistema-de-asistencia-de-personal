...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>ENTRADAS Y SALIDAS ALUMNOS</title>  
					...
					<div class="col-lg-12">
						<div class="table-responsive">        
							<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<?php 
								$sql="SELECT usuarios.ncontrol ,usuarios.nombres, usuarios.ap, usuarios.am, roles.rol, entradaysalida.fecha, entradaysalida.horain, entradaysalida.horaout FROM usuarios, entradaysalida, roles WHERE usuarios.id_rol = '3' and entradaysalida.id_usuario = usuarios.idusuario and usuarios.id_rol = roles.idrol";
