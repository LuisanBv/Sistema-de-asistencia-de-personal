...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>ENTRADAS Y SALIDAS EMPLEADOS</title>  
...
<body>
	...
	<!-- End header -->
	<!-- Start All Pages -->
	<div class="all-page-title page-breadcrumb3">
					...
					<div class="col-lg-12">
						<div class="table-responsive">        
							<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<?php 
								$sql="SELECT usuarios.ncontrol ,usuarios.nombres, usuarios.ap, usuarios.am, entradaysalida.fecha, entradaysalida.horain, entradaysalida.horaout, horario.area, horario.inicio, horario.fin FROM usuarios, entradaysalida, horario WHERE usuarios.id_rol = '2' and entradaysalida.id_usuario = usuarios.idusuario and usuarios.id_horario = horario.idhorario";
