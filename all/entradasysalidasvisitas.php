...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>ENTRADAS Y SALIDAS VISITANTES</title>  
...
<body>
	...
	<!-- End header -->
	<!-- Start All Pages -->
	<div class="all-page-title page-breadcrumb5">
					...
					<div class="col-lg-12">
						<div class="table-responsive">        
							<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<?php 
								$sql="SELECT visita.idvisita, visita.nombres, visita.ap, visita.am, visita.ocupacion, visita.edad, visita.sexo, visita.motivo, entradaysalida.fecha, entradaysalida.horain,  entradaysalida.horaout, entradaysalida.id_visita FROM visita, entradaysalida WHERE visita.idvisita = visita.idvisita  and entradaysalida.id_visita = visita.idvisita";
