...
<?php
   ...
   if(isset($_POST['idhorario'])){
	...
	include 'php/db2.php';
 	 $db = new Database();
    $query_usuario = $db->connect()->prepare("SELECT * FROM horario WHERE idhorario = '$id'");
    $query_usuario->execute();
    $usuarios = $query_usuario->fetchAll(PDO::FETCH_ASSOC);           
    foreach($usuarios as $usuario) {
                
				
				$id= $usuario['idhorario'];
            }
   		}
		?>
...
<body>
	...
	<div class="all-page-title page-breadcrumb9">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>REGISTRAR NUEVOS USUARIOS</h1>
				</div>
			</div>
		</div>
	</div>
...
<form action="php/registro.php" class="formulario" id="formulario">
	...
	<!------------------------------------------------>
			...
			<div class="formulario__grupo" id="grupo__nombres">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombres" id="nombres" placeholder="Ingrese su nombre" required>
			...
			<div class="formulario__ncon" id="grupo__ncontrol">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="ncontrol" id="ncontrol" placeholder="Ingrese el numero de control" required>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__ap">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="ap" id="ap" placeholder="Ingrese su Apellido" required>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__am">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="am" id="am" placeholder="Ingrese su Apellido" required>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__password">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="password" id="password" placeholder="Ingrese su contraseña" required>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__password2">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="password2" id="password2" placeholder="Ingrese nuevamente" required>
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__nombre">
				...
				<div class="formulario__grupo-input">
				<select class="custom-select d-block form-control" id="id_rol" name="id_rol" required data-error="Please select Person">
