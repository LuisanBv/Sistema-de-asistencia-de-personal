...
<?php
	...
	include 'php/db2.php';
 	 $db = new Database();
    $query_usuario = $db->connect()->prepare("SELECT * FROM usuarios WHERE idusuario = '$us'");
...
<body>
	...
	<!-- End header -->
	<!-- Start All Pages -->
	<div class="all-page-title page-breadcrumb11">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1><?PHP ECHO $_SESSION['nombre'], ' ',$_SESSION['ap'],' ',$_SESSION['am'];?> </h1>
				</div>
			</div>
		</div>
	</div>
