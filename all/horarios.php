					...
					<div class="col-lg-12">
						<div class="table-responsive">        
							<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<?php 
								$sql="SELECT horario.idhorario, horario.area ,horario.descripcion, horario.inicio, horario.fin FROM horario WHERE horario.idhorario = horario.idhorario";
